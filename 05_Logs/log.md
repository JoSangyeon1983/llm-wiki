...
2026-06-16 | MAINT | sources/README.md | 운영 보조장치 추가 — 등록 전 체크리스트(신뢰도·시의성·중복·포맷·라이선스·불변동결) + 엔트리 템플릿
2026-06-16 | MAINT | CLAUDE.md | §4 표현 형식 선택 기준표 신설(도표·1단계블릿·서브블릿·번호목록) + §7-A4 형식검수 연결, 캐치올 A1~A4 정합
